...
class HashSpecs extends Specification {

  val input: Seq[Int] = Seq(70,66,255,2,48,0,54,48,80,141,244,254,160,108,1,41)

  val chars: Seq[Char] = input.map(_.toChar)
...
0 (the first element in the list), a skip size (which starts at 0), and a sequence of lengths (your puzzle input).
...
${Hash.hashSimple(Seq(3, 4, 1, 5), 5) === 12}
...
${Hash.toAscii("1,2,3") === Seq(49,44,50,44,51)}
...
${Hash.fromStr("1,2,3") === Seq(49,44,50,44,51,17,31,73,47,23)}
...
${Hash.hashStr("")._1.distinct.length === 256}
...
${Hash.hashToXor(Seq(65, 27, 9, 1, 4, 3, 40, 50, 91, 7, 6, 0, 2, 5, 68, 22)) === Seq(64)}

Finally, the standard way to represent a Knot Hash is as a single hexadecimal string;
the final output is the dense hash in hexadecimal notation. Because each number in your dense hash will be
between 0 and 255 (inclusive), always represent each number as two hexadecimal digits (including a leading zero as necessary).
...
${Hash.xorToHex(Seq(64, 7, 255)) === "4007ff"}
