...
class StreamSpecs extends Specification {
  ...
  val input: String = readResource("2017/stream.txt")
...
${Stream("{}").score === 1}, score of 1.
${Stream("{{{}}}").score === 6}, 1 + 2 + 3
${Stream("{{},{}}").score === 5}, 1 + 2 + 2
${Stream("{{{},{},{{}}}}").score === 16}, 1 + 2 + 3 + 3 + 3 + 4
${Stream("{<a>,<a>,<a>,<a>}").score === 1}
${Stream("{{<ab>},{<ab>},{<ab>},{<ab>}}").score === 9}, score of 1 + 2 + 2 + 2 + 2
${Stream("{{<!!>},{<!!>},{<!!>},{<!!>}}").score === 9}, score of 1 + 2 + 2 + 2 + 2
${Stream("{{<a!>},{<a!>},{<a!>},{<ab>}}").score === 3}, score of 1 + 2

What is the total score for all groups in your input?
${Stream(input).score === 11089}
...
${Stream("<>").skipped === 0} characters.
${Stream("<random characters>").skipped === 17} characters.
${Stream("<<<<>").skipped === 3} characters.
${Stream("<{!>}>").skipped === 2} characters.
${Stream("<!!>").skipped === 0} characters.
${Stream("<!!!>>").skipped === 0} characters.
${Stream("<{o\"i!a,<{i<a>").skipped === 10} characters.

How many non-canceled characters are within the garbage in your puzzle input?
${Stream(input).skipped === 5288}
"""
}
